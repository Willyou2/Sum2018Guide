...
V &= \frac{1}{4\pi\epsilon_0}\left(-\frac{Q}{r} \bigg|_\infty^r\right) = \frac{1}{4\pi\epsilon_0}\left(-\frac{Q}{\infty} - \left(-\frac{Q}{r}\right)\right) = \frac{1}{4\pi\epsilon_0}\left(\frac{Q}{r}-0\right)\\
...
\begin{align*}
V &= -\int_\infty^r \vec{E} \dif \vec{s}\\
V &= -\int_\infty^c \frac{Q}{4\pi\epsilon_0 r^2} \dif r + \int_c^r \frac{Q}{4\pi\epsilon_0\epsilon_r r^2} \dif r\\
...
\begin{align*}
V &= \frac{1}{4\pi\epsilon}\frac{Q}{c} + \left(-\frac{1}{4\pi\epsilon_0\epsilon_r} \int_c^r \frac{Q}{r^2} \dif r\right)
\end{align*} 
\pagebreak
